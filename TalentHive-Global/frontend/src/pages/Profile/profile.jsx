                                    ...
                                    <div className='w-full'>
                                        ...
                                        <div className=' md:flex w-full justify-between'>
                                            <div className='my-5 flex gap-5'>
                                                ...
                                                <div className="cursor-pointer p-2 border-1 rounded-lg bg-blue-800 text-white font-semibold" onClick={copyToClipboard}>Share</div>
                                                {userData?._id === ownData?._id && <div onClick={handleLogout} className="cursor-pointer p-2 border-1 rounded-lg bg-blue-800 text-white font-semibold">Logout</div>}
                                            </div>
                                            <div className='my-5 flex gap-5'>
                                                {amIfriend() ? <div onClick={handleMessageModal} className="cursor-pointer p-2 border-1 rounded-lg bg-blue-800 text-white font-semibold">Message</div> : null}
                                                {userData?._id === ownData?._id ? null : <div onClick={handleSendFriendRequest} className="cursor-pointer p-2 border-1 rounded-lg bg-blue-800 text-white font-semibold">{checkFriendStatus()}</div>}
                                            </div>
                                        </div>
                                    </div>
                                </div>
